...
public class GeneralViewControllerFactory<C extends Controller<V>, V extends View<C>> implements ViewControllerFactory {
	private final Class<C> controllerClass;
	private final Class<V> viewClass;
	private final String routeName;

	public GeneralViewControllerFactory(Class<C> controllerClass, Class<V> viewClass, String routeName) {
